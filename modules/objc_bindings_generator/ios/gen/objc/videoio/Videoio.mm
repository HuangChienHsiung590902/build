...
+ (int)CAP_PROP_ANDROID_DEVICE_TORCH {
    return 8001;
}
...
//
+ (NSString*)getStreamBufferedBackendPluginVersion:(VideoCaptureAPIs)api version_ABI:(int*)version_ABI version_API:(int*)version_API {
    std::string retVal = cv::videoio_registry::getStreamBufferedBackendPluginVersion((cv::VideoCaptureAPIs)api, *(int*)(version_ABI), *(int*)(version_API));
    return [NSString stringWithUTF8String:retVal.c_str()];
}
