...
//
+ (void)fisheye_distortPoints:(Mat*)undistorted distorted:(Mat*)distorted Kundistorted:(Mat*)Kundistorted K:(Mat*)K D:(Mat*)D alpha:(double)alpha {
    cv::fisheye::distortPoints(undistorted.nativeRef, distorted.nativeRef, Kundistorted.nativeRef, K.nativeRef, D.nativeRef, alpha);
}

+ (void)fisheye_distortPoints:(Mat*)undistorted distorted:(Mat*)distorted Kundistorted:(Mat*)Kundistorted K:(Mat*)K D:(Mat*)D {
    cv::fisheye::distortPoints(undistorted.nativeRef, distorted.nativeRef, Kundistorted.nativeRef, K.nativeRef, D.nativeRef);
}
