...
public extension FaceRecognizerSF {
    @nonobjc class func create(framework: String, bufferModel: [UInt8], bufferConfig: [UInt8], backend_id: Int32, target_id: Int32) -> FaceRecognizerSF {
        let bufferModelVector = ByteVector(bufferModel)
        let bufferConfigVector = ByteVector(bufferConfig)
        let ret = FaceRecognizerSF.create(framework: framework, bufferModel: bufferModelVector, bufferConfig: bufferConfigVector, backend_id: backend_id, target_id: target_id)
        return ret
    }
}

public extension FaceRecognizerSF {
    @nonobjc class func create(framework: String, bufferModel: [UInt8], bufferConfig: [UInt8], backend_id: Int32) -> FaceRecognizerSF {
        let bufferModelVector = ByteVector(bufferModel)
        let bufferConfigVector = ByteVector(bufferConfig)
        let ret = FaceRecognizerSF.create(framework: framework, bufferModel: bufferModelVector, bufferConfig: bufferConfigVector, backend_id: backend_id)
        return ret
    }
}

public extension FaceRecognizerSF {
    @nonobjc class func create(framework: String, bufferModel: [UInt8], bufferConfig: [UInt8]) -> FaceRecognizerSF {
        let bufferModelVector = ByteVector(bufferModel)
        let bufferConfigVector = ByteVector(bufferConfig)
        let ret = FaceRecognizerSF.create(framework: framework, bufferModel: bufferModelVector, bufferConfig: bufferConfigVector)
        return ret
    }
}
